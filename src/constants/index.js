export const productList =  [
    ...
    },
    {
      ...
      projectCount: 4,
      techStack: ['Python' , 'NLP' ,  'Docker' , 'Docker Compose' , 'Huggie Face Transformers'],
    ...
    },
    {
      ...
      projectCount: 3,
      techStack: ['Python' , 'Data Validation' , 'Typescript' , 'ReactJS' , 'NestJS' , 'Hasura' , 'Streamlit'],
    ...
    },
    {
      ...
      projectCount: 3,
      techStack: ['Elixir' , 'Likeview' , 'Javascript' , 'ReactNative','Typescript'],
    ...
    },
    {
      ...
      projectCount: 5,
      techStack: ['ReactJS' , 'NodeJS' , 'Django' , 'Python', 'Cypress' , 'Typescript'],
    ...
    },
    {
      ...
      githubLink: 'https://github.com/Code4GovTech/C4GT23/wiki/ODK-Extension-and-Collection',
    },
    {
      title: 'Quiz Creator',
      description:
    ...
    },
    {
      ...
      projectCount: 6,
      techStack: ['Angular' , 'Javascript' ,  'Typescript' , 'React' , 'Scala' , 'Flink' , 'Kafka'],
    ...
    },
    {
      ...
      projectCount: 4,
      techStack: ['Angular' , 'JSON Schema' , 'Node' , 'Open source AI Tooling', 'ReactNative'],
    ...
    },
    {
      ...
      description:
        'Sunbird Knowlg consists of a set of tools and services that enable you to organise, curate, create, and discover millions of assets. It can be leveraged to organise content and knowledge assets as per domain and create targeted collections, courses, projects, video repositories, etc. ',
      projectCount: 3,
      techStack: ['Terraform' , 'Kubernets' , 'Docker' , 'Java', 'GraphDB' , 'Neo 4J' , 'Cypher' , 'Janus' , 'AngularJS'],
    ...
    },
    {
      ...
      projectCount: 3,
      techStack: ['Terraform' ,'Kubernets' , 'Docker' , 'Helm' , 'Kafka' , 'Elasticsearch' , 'Flink' , 'Apache Druid'],
