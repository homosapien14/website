  ...
  return (
    <div className="mb-4 relative hover:border-black">
      <input
        ...
        onFocus={handleFocus}
        onBlur={handleBlur}
        className="block w-full border border-gray-300 rounded bg-white py-2 px-3 hover:border-black focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
      <label className="absolute top-0 left-3 -mt-3 font-regular px-1 bg-white text-gray-500 text-sm transition-all pointer-events-none">
        {label}
      </label>
    </div>
  );
